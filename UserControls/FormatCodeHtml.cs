...
namespace SqlCodeEditor.UserControls
{
    ...
    public partial class FormatCodeHtml : Form
    {
        ...
        public FormatCodeHtml(string codeToFormat, string defaultLanguage)
        {
            ...
            {
                case SyntaxModes.TSql:
                    rbtsql.Checked = true;
                    break;
                case SyntaxModes.MySql:
                    rbMySql.Checked = true;
                    break;
                case SyntaxModes.PlSql:
                    rbPlSql.Checked = true;
                    break;
                case SyntaxModes.PostgreSql:
                    rbPostgreSql.Checked = true;
                    break;
                case SyntaxModes.SqliteSql:
                    rbSqliteSql.Checked = true;
                    break;
                default:
                    rbtsql.Checked = true;
                    break;
