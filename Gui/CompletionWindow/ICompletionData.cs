...
namespace SqlCodeEditor.Gui.CompletionWindow
{
    ...
    {
        SqlWordTokenType TokenType { get; set; }
        object DatabaseObject { get; set; }
    ...
    public class DefaultCompletionData : ICompletionData
    {
        ...
        string description;
        int imageIndex;
        SqlWordTokenType tokenType;
        object databaseObject;

        public SqlWordTokenType TokenType
        {
        ...
        {
            get { return this.databaseObject; }
        ...
        public DefaultCompletionData(string text, int imageIndex, SqlWordTokenType tokenType = SqlWordTokenType.None, object databaseObject = null)
        {
            this.text = text;
