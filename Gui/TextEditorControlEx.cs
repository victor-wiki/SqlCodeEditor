...
using SqlCodeEditor.Document.FoldingStrategy;
using SqlCodeEditor.UserControls;

// ReSharper disable once CheckNamespace
namespace SqlCodeEditor
{
    [ToolboxBitmap("SqlCodeEditor.Resources.TextEditorControl.bmp")]
    [ToolboxItem(true)]
    public class TextEditorControlEx : TextEditorControl
    {
        ...
        public FindAndReplaceForm FindForm => this._findForm;
        ...
        private void DoPaste()
        {
            ...
            ActiveTextAreaControl.Focus();
            ActiveTextAreaControl.TextArea.Focus();
        }
